  ...
  return <div className={pathname.startsWith('/play/') ? 'app-shell play-route' : 'app-shell'}>
    ...
    <header className="game-header">
      ...
      <div className="hud">
        ...
        <IconButton title="Mute or enable music and sound effects" aria-label={soundEnabled ? 'Turn sound preference off' : 'Turn sound preference on'} aria-pressed={soundEnabled} onClick={toggleSound}>{soundEnabled ? <Volume2 size={21}/> : <VolumeX size={21}/>}</IconButton>
